...
const Checkout = () => {
    ...
    return (
        ...
        <div className="flex justify-center text-left my-10">
            ...
            <div class="mb-6">
                ...
                <div class="mb-6">
                    <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Address</label>
                ...
                <div class="mb-6">
                    <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Phone number</label>
