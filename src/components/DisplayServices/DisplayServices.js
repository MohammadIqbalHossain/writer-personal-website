        ...
        <div>
            ...
            <img className="object-cover w-full h-96 rounded-t-lg md:h-auto md:w-48 md:rounded-none md:rounded-l-lg" src={picture} alt=""/>
                <div className="flex flex-col justify-between p-4 leading-normal">
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white text-left">{name}</h5>
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 text-left">{des}<button class="btn btn-link">Read more..</button></p>
                    <button className="btn btn-accent block md:mx-auto md:float-left">
